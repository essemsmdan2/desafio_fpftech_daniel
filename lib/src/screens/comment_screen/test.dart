// // ignore_for_file: prefer_const_constructors, unnecessary_new, no_leading_underscores_for_local_identifiers
...
//   List<String> items = ["Item 1", "Item 2", "Item 3", "Item 4", "Item 5", "Item 6", "Item 7", "Item 8"];
...
//                   image: new ExactAssetImage('assets/img_${index % items.length}.jpg'),
...
//                                 bottomLeft: new Radius.circular(10.0), bottomRight: new Radius.circular(10.0))),
//                         height: 30.0,
//                         child: new Row(
...
//                   new Expanded(child: ListView.builder(itemBuilder: (context, index) {
//                     return new ListTile(
//                       title: new Column(
//                         children: <Widget>[
//                           new Row(
